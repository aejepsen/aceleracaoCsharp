...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/acc-csharp-011-exercises-eshop.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd acc-csharp-011-exercises-eshop`
  ...
  - Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-acc-0x-exercises-eshop`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-acc-0x-exercises-eshop`

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/acc-csharp-011-exercises-eshop/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/acc-csharp-011-exercises-eshop/pulls) e confira que o seu _Pull Request_ está criado
...
<details>
  ...
  Para executar os testes com o .NET, execute o comando dentro do diretório do seu projeto `src/EShop` ou de seus testes `src/EShop.Test.Test`!
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH11&template=betrybe/acc-csharp-0x-exercises-eshop)
