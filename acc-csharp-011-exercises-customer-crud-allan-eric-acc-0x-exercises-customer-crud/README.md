...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/acc-csharp-011-exercises-customer-crud.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd acc-csharp-011-exercises-customer-crud`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/acc-csharp-011-exercises-customer-crud/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/acc-csharp-011-exercises-customer-crud/pulls) e confira que o seu _Pull Request_ está criado
