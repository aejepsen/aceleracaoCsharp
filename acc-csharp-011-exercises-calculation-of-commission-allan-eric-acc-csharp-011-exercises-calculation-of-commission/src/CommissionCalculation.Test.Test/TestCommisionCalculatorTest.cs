...
public class TestCommissionCalculatorTest4
{
    ...
    [InlineData("Nome Contribuidor", "janeiro",
        "O colaborador Nome Contribuidor neste mês de janeiro obteve o salário final de R$12000.00 referente à: SALARIO FIXO: R$0.00 TOTAL DE CARROS VENDIDOS: 0 VALOR TOTAL DE VENDAS NO MES: R$0.00 COMISSÃO POR CARROS VENDIDOS: R$250.00 COMISSÃO DE 3% DO TOTAL DE VENDAS: R$0.00"
    )]
